...
def process_csv_line(line, mode_filter):
    ...
    # Filter data based on the specified mode
    if mode in mode_filter:
        ...
        if (origin_state == '37' or dest_state == '37') or \
           (origin_cfs_area in ['37-268', '37-172', '37-450', '37-99999'] or dest_cfs_area in ['37-268', '37-172', '37-450', '37-99999']):
            ...
            # Instantiates Commodity Exchange Object using input data
            ...
            # Adds the Commodity Exchange Object to a List named cmd_ex_list
...
mode_choice = input("Select a mode (aerial, truck, maritime, rail): ")

if mode_choice == "aerial":
    mode_filter = ["11"]  # Air
    edge_color = 'orange'
elif mode_choice == "truck":
    mode_filter = ["03", "04", "05"]  # Truck
    edge_color = 'red'
elif mode_choice == "maritime":
    mode_filter = ["07", "08", "09", "10"]  # Maritime
    edge_color = 'blue'
elif mode_choice == "rail":
    mode_filter = ["06"]  # Rail
    edge_color = 'green'
else:
...
with open(csv_file_path, "r") as csv_file:
    ...
    for line in csv_file:
        process_csv_line(line, mode_filter)
...
nx.draw(G, pos, with_labels=True, node_color='lightblue', edge_color=edge_color, font_size=8, node_size=200)
plt.axis('off')
plt.title(f'Commodity Exchange Network ({mode_choice.capitalize()} Mode)')
plt.show()