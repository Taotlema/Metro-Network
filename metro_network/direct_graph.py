#Imports for managing File Handeling
import os
import csv
...
def process_csv_line(line):
    ...
    if (origin_state == '37' or dest_state == '37') or \
       (origin_cfs_area in ['37-268', '37-172', '37-450', '37-99999'] or dest_cfs_area in ['37-268', '37-172', '37-450', '37-99999']):
        ...
        #Instantiates Comodity Exchange Object using input data
        ...
        # Adds the Comodity Exchange Object to a List named cmd_ex_list
...
for cmd_ex in cmd_ex_list:
    ...
    #Edges between the orign and destination nodes
...
nx.draw(G, pos, with_labels=True, node_color='lightblue', edge_color='gray', font_size=8, node_size=200)
plt.axis('off')
plt.show()